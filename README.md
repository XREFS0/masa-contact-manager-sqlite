...
SQLite contact address book and phone directory management utility
...
```bash
python "Simple Contact Management System with SQLite in Python/index.py"
```
...
```
.
├── Simple Contact Management System with SQLite in Python
├── screenshots/
│   └── app_interface.png
├── .gitignore
├── LICENSE             # MIT License
